 ...
 * @author Guillermo
 */
public class Nickelodeon2 extends javax.swing.JPanel {
    ...
    public Nickelodeon2() {
        ...
        Nickelodeon2.diasParaEntrega.setText(Integer.toString(NickelodeonStudio.diasRestantesSem.availablePermits()));
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                if (nuevoValorSpinner > valorSpinnerDoblajes) {
                    if (desarrolladoresRestantes > 0) {
                        //FUNCION CREAR DESARROLLADOR NARRATIVA
                        // Llama a la función para crear un desarrollador de narrativa
                        NickelodeonStudio.crearActoresDeDoblaje(NickelodeonStudio.driveAnimacionesA, 0, 1, "A", true);
                        // Resta 1 a desarrolladoresRestantesB si el nuevo valor es mayor
                        int valorActual = Integer.parseInt(desarrolladoresRestantesA.getText());
                        valorActual--;
                        desarrolladoresRestantesA.setText(Integer.toString(valorActual));
    ...
    private void initComponents() {
        ...
        JuegosTotalesA = new javax.swing.JLabel();
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 610, 110, 20));

        guionesEnDriveA.setText("0");
        add(guionesEnDriveA, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 110, 20, -1));

        animacionEnDriveA.setText("0");
        add(animacionEnDriveA, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 170, 20, -1));

        doblajesEnDriveA.setText("0");
        add(doblajesEnDriveA, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 200, 20, -1));

        guionPlotEnDriveA.setText("0");
        add(guionPlotEnDriveA, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 230, 20, 10));
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 100, -1, 20));

        jLabel11.setText("ESTADO:");
        add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 380, -1, -1));

        estadoPM.setText(" ");
        add(estadoPM, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 380, 70, -1));

        jLabel13.setText("Faltas");
        add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 430, 40, -1));

        faltasPM.setText("0");
        add(faltasPM, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 440, 30, -1));
        ...
        add(descontadoPM, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 410, 30, -1));

        jLabel19.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(255, 255, 255));
        jLabel19.setText("CAPITULOS GENERADOS");
        add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 590, -1, -1));

        gananciaA.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        gananciaA.setForeground(new java.awt.Color(255, 255, 255));
        gananciaA.setText("0");
        add(gananciaA, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 550, 70, 10));

        jLabel21.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel21.setForeground(new java.awt.Color(255, 255, 255));
        jLabel21.setText("CON PLOT");
        add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 620, -1, -1));
        ...
        add(capitulosGeneradosA, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 590, 70, 20));

        jLabel24.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel24.setForeground(new java.awt.Color(255, 255, 255));
        jLabel24.setText("INGRESOS BRUTO");
        add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 520, 110, -1));

        jLabel25.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel25.setForeground(new java.awt.Color(255, 255, 255));
        jLabel25.setText("GANANCIA");
        add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 550, -1, -1));
        ...
        add(capitulosPlotGeneradosA, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 620, 70, 20));
        ...
        add(ingresosBrutosA, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 520, 70, 10));

        JuegosTotalesA.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        JuegosTotalesA.setForeground(new java.awt.Color(255, 255, 255));
        JuegosTotalesA.setText("0");
        add(JuegosTotalesA, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 580, 60, -1));
        ...
        add(diasParaEntrega, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 610, 40, -1));

        escenariosEnDriveA.setText("0");
        add(escenariosEnDriveA, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 140, 20, -1));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel3.setText("Desarrolladores restantes:");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, 200, 20));

        desarrolladoresRestantesA.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        desarrolladoresRestantesA.setText("17");
        add(desarrolladoresRestantesA, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 40, 50, 20));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Guionistas:");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 110, -1, -1));
        ...
        add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 20, 170, -1));

        jPanel5.setBackground(new java.awt.Color(255, 204, 102));
        jPanel5.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 153, 51), 5));
        jPanel5.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 570, 290, 80));
        ...
        jPanel7.add(costosOperativosA, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 10, 70, 10));

        add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 480, 230, 160));
        ...
        add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 380, 250));
        ...
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 350, 100, 20));

        jLabel26.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel26.setText("Project Manager");
        jPanel1.add(jLabel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 10, -1, -1));

        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 340, 200, 130));
        ...
        jPanel4.add(estadoDirector, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 40, 200, 20));

        jLabel27.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel27.setText("Director");
        jPanel4.add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 10, -1, -1));

        add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 480, 300, 80));

        jLabel32.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/nick-rebrand-2023_5 (1).png"))); // NOI18N
        add(jLabel32, new org.netbeans.lib.awtextra.AbsoluteConstraints(-200, -80, 1170, 820));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Nickelodeon2().setVisible(true);
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JLabel JuegosTotalesA;
    public static javax.swing.JLabel animacionEnDriveA;
    public static javax.swing.JLabel capitulosGeneradosA;
    private javax.swing.JLabel capitulosPlotGeneradosA;
    private javax.swing.JLabel costosOperativosA;
    ...
    public JLabel getJuegosTotalesA() {
        return JuegosTotalesA;
    }

    public void setJuegosTotalesA(JLabel JuegosTotalesA) {
        this.JuegosTotalesA = JuegosTotalesA;
    }
    ...
    public static void setDiasParaEntrega(JLabel diasParaEntrega) {
        Nickelodeon2.diasParaEntrega = diasParaEntrega;
    }
    ...
    public static void setSpinnerGuion(JSpinner spinnerGuion) {
        Nickelodeon2.spinnerGuion = spinnerGuion;
    }
